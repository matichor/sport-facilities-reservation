...
import static com.reservation.sport.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
@SpringBootTest(classes = SportPlaceReservationApp.class)
@Transactional
