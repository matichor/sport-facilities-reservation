...
(function () {
    ...
    function reservationCtrl($scope, $filter, $translate, reservationAPIFactory, reservationConfig, reservationService) {
        ...
        function getAvailableHours(date) {
            ...
            var params = {selectedDate: selectedDateFormatted, objectDefinitionId: vm.datepickerOptions.request.id};
        ...
        function reserve(date, hour, userData) {
            ...
            var selectedDateFormatted = $filter('date')(date, vm.dateFormat);
            var params = {selectedDate: selectedDateFormatted, selectedHour: hour, userData: userData, objectDefinitionId: vm.datepickerOptions.request.id};
