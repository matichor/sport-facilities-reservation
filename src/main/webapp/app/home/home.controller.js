(function() {
    ...
    HomeController.$inject = ['$scope', 'Principal', 'LoginService', '$state', '$filter', 'BookingEventServiceDialog',  'AddNewObjectDialogService'];

    function HomeController ($scope, Principal, LoginService, $state, $filter, BookingEventServiceDialog, AddNewObjectDialogService) {
        var vm = this;
